...
export type zappar_pipeline_t = number & {_: 'zappar_pipeline_t'};

export type zappar_camera_source_t = number & {_: 'zappar_camera_source_t'};

export type zappar_image_tracker_t = number & {_: 'zappar_image_tracker_t'};

export type zappar_face_tracker_t = number & {_: 'zappar_face_tracker_t'};

export type zappar_face_mesh_t = number & {_: 'zappar_face_mesh_t'};

export type zappar_barcode_finder_t = number & {_: 'zappar_barcode_finder_t'};

export type zappar_instant_world_tracker_t = number & {_: 'zappar_instant_world_tracker_t'};
